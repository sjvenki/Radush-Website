            ...
            {/* <div style={{ display: 'flex', alignItems: 'center' }}> */}
              ...
              <Card sx={{ maxWidth: 345 }}>
                <CardActionArea>
                  <CardMedia
                    ...
                    alt="ramesh"
                    loading="lazy"
                   sx={{objectFit:'contain',marginTop:'4px',marginBottom:'4px'}}
                  />
              ...
              {/* <div style={{marginTop:'90px'}}> */}
                ...
                <ul style={{fontSize:'20px'}}>
                  ...
                  <li>With a distinguished track record in transforming global operational systems profitably and efficiently, Ramesh is the technical force behindQRCode4you.com.</li>
