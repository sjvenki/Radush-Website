...
export const Login = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center">
      <div className="py-5 my-2 mx-1 shadow-xl bg-nav max-w-screen-sm px-14">
        <div className="flex flex-col justify-center items-center">
          <img
            src={login}
            alt="login image"
        ...
        <div className="flex flex-col justify-center items-center ">
          <form onSubmit={handleSubmit} className="flex flex-col text-xs">
            ...
            <div className="flex justify-between">
              ...
              />{" "}
              <button className="px-1 cursor-pointer" onClick={togglePassword}>
                {showPassword ? (
                  <svg
            ...
            {errors.password && <p className="text-alert">{errors.password}</p>}
            <button
              type="submit"
              value="submit"
              className="bg-primary my-2 rounded-md"
            >
              Login
            </button>
          </form>
...
export const Register = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center">
      <div className="py-10 my-5 mx-1 shadow-xl bg-nav max-w-screen-sm px-14">
        ...
        <div className="flex flex-col justify-center items-center text-xs">
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="bg-primary font-bold tracking-wider my-2 px-4 py-2 w-full rounded-md"
            >
              Register
            </button>
          </form>
